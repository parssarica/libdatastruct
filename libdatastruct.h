...
int lds_linkedlist_insert(lds_linkedlist *, size_t, const void *, size_t);
...
size_t lds_stack_capacity(const lds_stack *);
...
ssize_t lds_bintree_data_size(const lds_bintree *);
...
ssize_t lds_tree_data_size(const lds_tree *);
...
size_t lds_tree_depth(lds_tree *);
lds_tree *lds_tree_sibling(const lds_tree *, size_t);
size_t lds_tree_sibling_count(const lds_tree *);
...
ssize_t lds_graph_data_size(const lds_graph *);
