...
ssize_t lds_string_find_len(const lds_string *, char *, size_t);
ssize_t lds_string_find(const lds_string *, char *);
int lds_string_contains_len(const lds_string *, char *, size_t);
